class Hero {
    ...
    getHero() {
        return `<img src="image/pikachu.png" alt="Hero" width="${this.width}px" height= ${this.height}px style="top:${this.top}px; left:${this.left}px; position:absolute;">`;
    }
...
let pikachu = new Hero("pikachu.png", 0, 0, 100, 110, 3, RIGHT);
